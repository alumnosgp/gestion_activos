...
//     const url = "/gestion_activos/API/incidentes/eliminar";
//     const headers = new Headers();
//     headers.append("X-Requested-With", "fetch");
//     const config = {
//       method: "POST",
...
//   const url = "/gestion_activos/API/incidentes/modificar";
//   const config = {
//     method: "POST",
//     body,
//   };
...
const buscarNombres = async () => {
  ...
  const fetchData = async () => {
    const url = `/gestion_activos/API/incidentes/buscarNombres?maq_per_alta=${per_catalogo}`;
    const config = {
      method: "GET",
    };
    try {
...
const buscarPlanillero = async () => {
  ...
  clearTimeout(typingTimeout);
  const fetchData = async () => {
    const url = `/gestion_activos/API/incidentes/buscarPlanillero?maq_per_planilla=${pcivil_catalogo}`;
    const config = {
      method: "GET",
    };
    try {
