...
class EstadisticaIncidenteController
{
    ...
    public static function buscarCategoriasEstadistica()
    {
        ...
        FROM  incidente i        
        INNER JOIN detalle_categ_inc dci ON inc_no_incidente = dci.det_categ_id_incidente
...
/* FUNCION PARA MANDAR A LLAMAR LOS DATOS DE EL 2 DIV EN LA VISTA */
    ...
    FROM 
        incidente i
        INNER JOIN resolicion_incidente res_inc ON inc_no_incidente = res_inc.res_inc_incidente_id
    ...
    FROM 
        incidente i
        INNER JOIN detalle_inc d ON inc_no_incidente = d.det_inc_id_incidente
    WHERE 
        i.inc_situacion = 1
    GROUP BY 
        d.det_inc_estatus
