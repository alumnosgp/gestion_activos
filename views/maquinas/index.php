...
<div class="row justify-content-center my-4">
    <form class="col-lg-8 border bg-light p-3" id="formularioMaquinas">
        ...
        <div class="row mb-3" name="perPlanillero" id="personalPlanilla">
            <div class="col">
                <label for="maq_per_planilla">CATALOGO PLANILLERO</label>
                <input type="text" name="maq_per_planilla" id="maq_per_planilla" class="form-control"
                    placeholder="Ingrese catalogo">
            </div>
            <div class="col">
                <label for="pcivil_nombre">NOMBRE PLANILLERO</label>
                <input type="text" name="pcivil_nombre" id="pcivil_nombre" class="form-control" placeholder="nombre" readonly>
            </div>
            <div class="col">
                <label for="pcivil_gradi">GRADO PLANILLERO</label>
                <input type="text" name="pcivil_gradi" id="pcivil_gradi" class="form-control" placeholder="grado" readonly>
            </div>

            <div class="row mb-3">
                <div class="col">
                    <label for="pcivil_plaza">PUESTO PLANILLERO</label>
                    <input type="text" name="pcivil_plaza" id="pcivil_plaza" class="form-control" placeholder="puesto" readonly>
                </div>
            </div>
        </div>
        <div class="mb-3">
