        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarToggler">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="margin: 0;">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="/gestion_activos/menu"><i class="bi bi-house-fill me-2"></i>Inicio</a>
                    </li>
                    ...
                    <div class="nav-item dropdown " >
                        ...
                        <ul class="dropdown-menu  dropdown-menu-dark "id="dropwdownRevision" style="margin: 0;">
                            ...
                            <li>
                                <a class="dropdown-item nav-link text-white " href="/gestion_activos/menu"><i class="ms-lg-0 ms-2 bi bi-plus-circle me-2"></i>MENU</a>
                            </li>            
                            <!-- <li>
                                <a class="dropdown-item nav-link text-white " href="/gestion_activos/personasplanillas"><i class="ms-lg-0 ms-2 bi bi-plus-circle me-2"></i>REGISTRO DE PERSONAS PLANILLA</a>
                            </li>            
                ...
                <div class="col-lg-1 d-grid mb-lg-0 mb-2">
                    ...
                    <a href="/gestion_activos/menu" class="btn btn-danger"><i class="bi bi-arrow-bar-left"></i>CERRAR SESION</a>
                </div>
