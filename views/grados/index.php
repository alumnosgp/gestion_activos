<h1 class="text-center mt-5">GESTION DE GRADOS</h1>
<div class="row justify-content-center my-4">
    <form class="col-lg-8 border bg-light p-3" id="formularioGrados">
        <input type="hidden" name="grado_id" id="grado_id" class="form-control">
        <div class="row mb-3">
            <div class="col">
                <label for="grado_descr">INGRESE GRADOS</label>
                <input type="text" name="grado_descr" id="grado_descr" class="form-control">
            </div>
        </div>      
        <div class="row">
            <div class="col">
