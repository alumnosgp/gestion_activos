            ...
            <div class="modal-body">
                <form action="" id="modalDescrip">
                    ...
                    <button type="button" id="btnModificarDescrip" class="btn btn-warning"
                        data-bs-dismiss="modal"><i class="fa-solid fa-user-pen"></i>  Modificar</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="modalCategoria">
                    ...
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><i class="fa-solid fa-xmark"></i>  Cerrar</button>
                    <button type="button" id="btnModificarCategoria" class="btn btn-warning" data-bs-dismiss="modal"><i class="fa-solid fa-user-pen"></i>  Modificar</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="col" id="modalResolucion">
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <h4 class="modal-title" id="">Entidades internas notificadas</h4><i class="fa-solid fa-comments"></i>
                        ...
                        <div class="col">
                            <h4 class="modal-title" id="">Entidades externas notificadas</h4><i class="fa-solid fa-comments"></i>
