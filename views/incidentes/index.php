        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" id="modalDescrip">
                    ...
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><i
                            class="fa-solid fa-xmark"></i> Cerrar</button>
                    <button type="button" id="btnModificarDescrip" class="btn btn-warning" data-bs-dismiss="modal"><i
                            class="fa-solid fa-user-pen"></i> Modificar</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="modalCategoria">
                    ...
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><i
                            class="fa-solid fa-xmark"></i> Cerrar</button>
                    <button type="button" id="btnModificarCategoria" class="btn btn-warning" data-bs-dismiss="modal"><i
                            class="fa-solid fa-user-pen"></i> Modificar</button>
...
<button type="button" id="datatableShow" class="btn btn-outline-primary">Buscar</button>
<!--////////////////////////////////////////////DATATABLE///////////////////////////////////////////////////////////////-->
<div class="row justify-content-center">
    <div class="col table-responsive" id='datatable'>
