...
class Personaplanilla extends ActiveRecord
{
    ...
    protected static $columnasDB = ['pcivil_catalogo', 'pcivil_nombre1', 'pcivil_nombre2', 'pcivil_apellido1',
    'pcivil_apellido2', 'pcivil_gradi', 'pcivil_dpi', 'pcivil_plaza', 'pcivil_telefono', 'pcivil_direccion',
    'pcivil_emal','pcivil_situacion'];
    ...
    public function __construct($args = []){
        ...
        $this->pcivil_gradi = $args['pcivil_gradi'] ?? '';
